...
import static de.kreth.clubhelper.personedit.aspects.AbstractLoggerAspect.LogLevel.DEBUG;
import static de.kreth.clubhelper.personedit.aspects.AbstractLoggerAspect.LogLevel.ERROR;
...
public class ControllerLoggerAspect extends AbstractLoggerAspect {
    ...
    @Pointcut("execution (public * de.kreth.clubhelper.personedit.remote..*(..))")
